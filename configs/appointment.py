...
underButtonSendMessageList=['預約練習場','預約維修','預約高爾夫球','預約打蠟','預約包磨','預約烤漆']
...
def activeTimes(userphone):
    return bot_configsDB.TableOneSearch('companyphone',userphone)[0]['activeTimes']
...
#notify token
NOTIFYTOKEN='tkCI6B27dX1yKsdCTzKFgXDfzuQszNjM8OsEVH0oYJr'
