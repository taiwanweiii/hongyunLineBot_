...
class Line:
    ...
    def flexTemplate(filename):
        with open(f"templates/{filename}.json", 'r', encoding="utf-8") as f:
            data = json.load(f)
        return data
    ...
    def replyFlex(self, contents, alt_text='-'):
        self.replyMessage(FlexSendMessage(contents=contents,
                                          alt_text=alt_text))
    ...
    def pushdoubleMessageTextReplyFlex(self,
                                       userId,
                                       text1,
                                       flex_contents,
                                       alt_text='-'):
