            ...
            match event.type:
                case "follow":
                    ...
                    template["hero"]["action"][
                        "uri"
                    ] = f"https://liff.line.me/{liffID}?url=login"
                ...
                case "message":
                    ...
                    if user_status == "phone":
                        ...
                        if event.message == "男" or event.message == "女":
                            memberRegistertemplate["hero"]["contents"][1]["contents"][
                                0
                            ]["contents"][2]["contents"][1]["text"] = event.message
                        ...
                        if event.message == "#個人狀況":
                            if memberRole >= 2:
                                ...
                                while i < len(projectlist):
                                    templateAdd["hero"]["contents"][0]["url"] = (
                                        imageUrl[i]
                                    )
                                    templateAdd["hero"]["contents"][1]["contents"][0][
                                        "text"
                                    ] = "鴻運高爾夫工坊"
                                    templateAdd["hero"]["contents"][2]["contents"][1][
                                        "contents"
                                    ][0]["text"] = f"點擊查看{projectlist[i]}"
                                    templateAdd["hero"]["action"][
                                        "data"
                                    ] = f"personalData:{projectlist[i]}"
                                    templateAdd["hero"]["action"][
                                        "displayText"
                                    ] = f"{projectlist[i]}查詢"
                            ...
                            event.message in underButtonSendMessageList
                            and reserve.isReserveDBState(event.uid, company)
                            == "noProject"
                        ):
                            ...
                            for i in range(7):
                                if (
                                    projectsActive[i][0][0] == "00:00"
                                    and projectsActive[i][0][1] == "00:00"
                                ):
                            ...
                            for idx, ts in enumerate(dayList):
                                ...
                                if not weekday_chinese[dt.weekday()] in blackweekday:
                                    ...
                                    if len(template["contents"]) < typePage:
                                        ...
                                        template["contents"][typePage - 1]["body"][
                                            "contents"
                                        ] = []
                                    template_item[0]["contents"][0][
                                        "text"
                                    ] = f"{dt.month}/{dt.day} ({weekday_chinese[dt.weekday()]})"
                                    template_item[0]["contents"][1]["action"][
                                        "data"
                                    ] = f"appointment_choose_time:{int(ts)} project:{projectName}"
                                    template["contents"][typePage - 1]["body"][
                                        "contents"
                                    ].append(copy.deepcopy(template_item[0]))
                                    template["contents"][typePage - 1]["body"][
                                        "contents"
                                    ].append(copy.deepcopy(template_item[1]))
                                    idex += 1
                                else:
                            ...
                            template["hero"]["contents"][1]["contents"][0]["contents"][
                                1
                            ]["contents"][1][
                                "text"
                            ] = member.memberDB.dynamicTableSearch(
                            ...
                            if len(sortFilteredDataTime) > 0:
                                ...
                                for correctData in sortFilteredDataTime:
                                    ...
                                    templateAdd[0]["contents"][1]["text"] = correctData[
                                        "project"
                                    ]
                                    templateAdd[1]["contents"][1][
                                        "text"
                                    ] = formattedYYYYMMDDhhmm
                                    template["hero"]["contents"][1]["contents"][1][
                                        "contents"
                                    ].append(copy.deepcopy(templateAdd[0]))
                                    template["hero"]["contents"][1]["contents"][1][
                                        "contents"
                                    ].append(copy.deepcopy(templateAdd[1]))
                                    template["hero"]["contents"][1]["contents"][1][
                                        "contents"
                                    ].append(copy.deepcopy(templateAdd[2]))
...
🌷週日和例假日公休
                            ...
                            template = copy.deepcopy(line.flexTemplate("checkinRecord"))
                            templateAdd = copy.deepcopy(
                            ...
                            # 前三十天
                            start_time = (datetime.now() - timedelta(days=30)).strftime(
                                "%Y-%m-%d"
                            )
                    ...
                    match event.postback:
                        ...
                        case data if data.startswith("appointment_confirm_reserve:"):
                            ...
                            if reserve.isReserveDBState(event.uid, company) == True:
                                ...
                                template["body"]["contents"][0]["contents"][0][
                                    "contents"
                                ][1]["text"] = memberSearchData["name"]
                                template["body"]["contents"][0]["contents"][2][
                                    "contents"
                                ][1]["text"] = memberSearchData["phone"]
                                        ...
                                        lnumber = reserve.reserveDB.dynamicTableSearch(
                                            {
                                                ...
                                                "status": "1",
                                                "company": company,
                                                "dataTime": userReservedate["dataTime"],
                                            }
                                        )
                                        lnumber = len(lnumber)
                        ...
                        case "register":
                            ...
                            if not memberDB.TableOneSearchAddField(
                                "userId", "userId", event.uid, "company", company
                            ):
                        ...
                        case data if data.startswith("personalData:"):
                            ...
                            if personalData == "球桿數據":
                                ...
                                for index, value in enumerate(clubDataSearch):
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][1]["contents"][0]["contents"][1]["text"] = value[
                                        "ballHead"
                                    ]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][1]["contents"][1]["contents"][1]["text"] = value[
                                        "clubHead"
                                    ]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][2]["contents"][0]["contents"][1]["text"] = value[
                                        "shaftWeightStiffness"
                                    ]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][2]["contents"][1]["contents"][1]["text"] = value[
                                        "gripWeight"
                                    ]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][3]["contents"][0]["contents"][1]["text"] = value[
                                        "swingWeight"
                                    ]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][3]["contents"][1]["contents"][1]["text"] = value[
                                        "clubfaceAngle"
                                    ]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][4]["contents"][0]["contents"][1]["text"] = value[
                                        "lieAngle"
                                    ]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][5]["contents"][0]["contents"][1]["text"] = value[
                                        "remark"
                                    ]
                                    template["contents"].append(
                                        copy.deepcopy(templateAdd)
                            ...
                            if personalData == "揮桿數據":
                                ...
                                for index, value in enumerate(playclubSearch):
                                    templateAdd["body"]["contents"][0]["contents"][0][
                                        "text"
                                    ] = value["name"]
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ...
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        ...
                                        "text"
                                    ] = f"{value['averageToTalDistance']}y"
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][2]["contents"][0]["contents"][1][
                                        "text"
                                    ] = f"{value['averageFlightDistance']}y"
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][2]["contents"][1]["contents"][1][
                                        "text"
                                    ] = f"{value['takeoffAngle']}°"
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                                    ][3]["contents"][0]["contents"][1][
                                        "text"
                                    ] = f"{value['ballSpeed']}"
                                    templateAdd["body"]["contents"][0]["contents"][1][
                                        "contents"
                        ...
                        case data if data.startswith("postReserveProject:") and (
                            user_status == True
                        ):
                            if memberRole >= 1:
                                ...
                                if reserveProjectName in projectNameList:
                                    ...
                                    template["contents"][0]["header"]["contents"][0][
                                        "text"
                                    ] = f"{reserveProjectName}-請選擇日期"
                                    for i in range(7):
                                        if (
                                            projectsActive[i][0][0] == "00:00"
                                            and projectsActive[i][0][1] == "00:00"
                                    ...
                                    for idx, ts in enumerate(dayList):
                                        ...
                                        day = dt.day
                                        if (
                                            not weekday_chinese[dt.weekday()]
                                            in blackweekday
                                        ):
                                            typePage = (
                                                (idex / datapage) + 1
                        ...
                        case data if data.startswith(
                            ...
                            if (
                                reserve.isReserveDBState(event.uid, company)
                                == "noDataTime"
                            ):
                                ...
                                projectSumberOfAppointments = (
                                    projectSnumberOfAppointmentsList[projectNameIdx]
                                )
                                # print('--------projectGroupReserveStatusList---------')
                                # print(projectGroupReserveStatusList)
                                projectGroupReserveStatus = (
                                    projectGroupReserveStatusList[projectNameIdx]
                                )
                                ...
                                currentUnixTime = (
                                    int(current_time.timestamp()) + projectsinterval
                                )
                                ...
                                if timeUnix == todayhourminZeroUnixTimestamp:
                                    if (unixActive[dt.weekday()])[1][0] == None:
                                        while (unixActive[dt.weekday()][0][0]) < (
                                        ...
                                        while (unixActive[dt.weekday()][1][0]) < (
                                ...
                                filterBlackTimeUnix = [
                                    ...
                                    if not any(
                                        range_item[0] <= timestamp <= range_item[1]
                                ...
                                if filterBlackTimeUnix:
                                    ...
                                    if filterTimeUnix and isMaxCount:
                                        ...
                                        dateFormatYYYYMMDD = (
                                            datetime.fromtimestamp(
                                                int(filterTimeUnix[0]), TZ
                                            )
                                        ).strftime("20%y年%m月%d日")
                                        ...
                                        for idx, ts in enumerate(filterTimeYYYYDDList):
                                            ...
                                            template_item[0]["contents"][1]["action"][
                                                "data"
                                            ] = f"appointment_confirm_reserve:{filterTimeUnix[idx-1]}:projectName:{projectName}"
                                            template["contents"][typePage - 1]["body"][
                                                "contents"
                                            ].append(copy.deepcopy(template_item[0]))
                                            template["contents"][typePage - 1]["body"][
                            ...
                            if memberRole >= 1:
                                ...
                                if searchBallRollfillterTrue:
                                    for key, value in searchBallRollfillterTrue.items():
                                        k = i % 3
                                        ballRoll["hero"]["contents"][0]["contents"][0][
                                            "url"
                                        ] = urlList[k]
                                        ballRoll["hero"]["contents"][0]["contents"][1][
                                            "text"
                                        ] = value["courtName"]
                                        ballRoll["hero"]["contents"][1]["contents"][0][
                                            "action"
                                        ][
                                            "data"
                                        ] = f"chooseBallRoll:{value['courtName']}"
                        ...
                        case data if data.startswith("chooseBallRoll:"):
                            ...
                            getReserveTimeList = [
                                item["dataTime"] for item in historySearchStatusUserId
                            ]
                            nowTime = getDatetime()
                            nowTimeUinx = int(nowTime.timestamp())
                            ballRollDataList = []
                            ...
                            filtered_month_number = {
                                key: value
                                for key, value in monthNumber.items()
                                if int(ballRollList["monthNumber"][str(int(key))]) > 0
                                and int(key) >= unix_timestamp
                            }
                        ...
                        case data if data.startswith("ballRollunixTime:") and (
                            "ballRollnumber:" in data
                        ) and ("ballRollName:" in data):
                            parts = data.split(":")
                            unixTime = parts[1]
                            number = parts[3]
                            name = parts[5]
                        ...
                        case data if data.startswith("ballRollunixTime:") and (
                            ...
                            template["body"]["contents"][0]["contents"][0]["contents"][
                                1
                            ]["text"] = memberSearchData["name"]
                            template["body"]["contents"][0]["contents"][2]["contents"][
                                1
                            ]["text"] = memberSearchData["phone"]
                            template["body"]["contents"][1]["contents"][1]["action"][
                                "data"
                            ] = f"ballRollConfirmf:ballRollunixTime:{unixTime}:number:{number}:ballRollName:{name}"
                            template["body"]["contents"][1]["contents"][0]["action"][
                                "data"
                            ] = "CancelBallRollReservation"
                            # timeFormatYYYYMMDDhhmm=(datetime.fromtimestamp(isReserveFunction.shortDBSearch()[0]['dataTime'],TZ)).strftime("%Y年%m月%d日 %H:%M")
                            ...
                            reserveProjectName = reserve.reserveDB.dynamicTableSearch(
                                {"userId": event.uid, "status": "0", "company": company}
                            )[0]["project"]
                            template["body"]["contents"][0]["contents"][4]["contents"][
                                1
                            ]["text"] = name

                            template["body"]["contents"][0]["contents"][6]["contents"][
                                1
                            ]["text"] = unixTime
                            template["header"]["contents"][0]["text"] = "球卷確認單"
                            line.replyFlex(template)
                        case data if data.startswith(
                            "ballRollConfirmf:ballRollunixTime:"
                        ) and ("number:" in data) and ("ballRollName:" in data):
                            if memberRole >= 2:
                                reserveCount = configs.appointment.reserveCount
                                # isReserveFunction=reserve.ShortAndHistoryReserveFunction(event.uid)
                                NOTIFYTOKEN = configs.appointment.NOTIFYTOKEN
                                ...
                                if (
                                    isBallRollHistoryNumber + int(number)
                                ) > configsNumber:
                                    line.replyText(
                                    ...
                                    if (
                                        reserve.reserveDB.execute_query(
                                        ...
                                        if count < reserveCount:
                                            ...
                                            userReservedate = (
                                                reserve.reserveDB.ballRollrdbmsSearch(
                                                    company, event.uid
                                                )[0]
                                            )
                                            reserve.reserveDB.updateThreeSearchWhere(
...
def getIsProject(phone):
    ...
    if isinstance(botConfigsSearchAll, list) and botConfigsSearchAll is not None:
        ...
        if publicData is not None:
            publicBlackTimeList = [
                item["deniedDates"] for item in publicData_dict if item["status"] == 0
            ]

        searchBallRoll_dict = botConfigsSearchAll[0]["ballRoll"]

        if (
            not isinstance(searchBallRoll_dict, list)
        ...
        projects_with_status_1 = [
            ...
            and details.get("name") is not None
        ...
        if (
            not isinstance(reserveProjectListStr, list)
...
def pushRemindMessage():
    ...
    for index, item in enumerate(reserveList):
        if (
            item["dataTime"] < end_unix_timestamp
